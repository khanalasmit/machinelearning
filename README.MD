...
|**10**| ONEHOTENCODING| Deatails of the one hot encoding. OnehotEncoding using <br> 1.**`pd.get_dummies()`** <br>
    2. **`pd.get_dummies(dropfirst=<b>True</b>)`** <br>3. **`sklearn.preprocessing.OneHotEncoder()`**|
